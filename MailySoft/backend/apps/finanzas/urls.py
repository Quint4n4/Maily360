...
urlpatterns = [
    ...
    path(
        "finanzas/conceptos/<uuid:concept_id>/",
        ConceptDetailApi.as_view(),
        name="finanzas-concept-detail",
    ),
    # Catálogo de paquetes de tratamientos (Fase 3 — Calendarización)
    path("finanzas/paquetes/", PackageListCreateApi.as_view(), name="finanzas-package-list"),
    path(
        "finanzas/paquetes/<uuid:package_id>/",
        PackageDetailApi.as_view(),
        name="finanzas-package-detail",
    ),
    ...
    path(
        "finanzas/cotizaciones/<uuid:quote_id>/",
        QuoteDetailApi.as_view(),
        name="finanzas-quote-detail",
    ),
    path(
        "finanzas/cotizaciones/<uuid:quote_id>/enviar/",
        QuoteSendApi.as_view(),
        name="finanzas-quote-send",
    ),
    path(
        "finanzas/cotizaciones/<uuid:quote_id>/aceptar/",
        QuoteAcceptApi.as_view(),
        name="finanzas-quote-accept",
    ),
    path(
        "finanzas/cotizaciones/<uuid:quote_id>/pdf/",
        QuotePdfApi.as_view(),
        name="finanzas-quote-pdf",
    ),
    # Cargos
    path("finanzas/cargos/", ChargeListCreateApi.as_view(), name="finanzas-charge-list"),
    path(
        "finanzas/cargos/<uuid:charge_id>/",
        ChargeDetailApi.as_view(),
        name="finanzas-charge-detail",
    ),
    # Pagos
    path("finanzas/pagos/", PaymentListCreateApi.as_view(), name="finanzas-payment-list"),
    path(
        "finanzas/pagos/<uuid:payment_id>/",
        PaymentDetailApi.as_view(),
        name="finanzas-payment-detail",
    ),
    # Estado de cuenta
    path(
        "finanzas/estado-cuenta/<uuid:patient_id>/",
        AccountStatementApi.as_view(),
        name="finanzas-statement",
    ),
    # CFDI
    ...
    path(
        "finanzas/cfdi/<uuid:cfdi_id>/cancelar/",
        CfdiCancelApi.as_view(),
        name="finanzas-cfdi-cancel",
    ),
    # Dashboard
