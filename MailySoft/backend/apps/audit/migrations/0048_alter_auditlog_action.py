...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("audit", "0047_alter_auditlog_action"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("TENANT_ENTITLEMENTS_SET", "Ajustar derechos de una clínica"),
                    ...
                    ("CLINIC_TEAM_MEMBER_CREATE", "Crear miembro del equipo de la clínica"),
                    ("CLINIC_TEAM_MEMBER_UPDATE", "Actualizar miembro del equipo de la clínica"),
                    ("CLINIC_TEAM_MEMBER_DELETE", "Eliminar miembro del equipo de la clínica"),
                    ...
                    ("DOCUMENT_TEMPLATE_CREATE", "Crear plantilla de documento"),
                    ("DOCUMENT_TEMPLATE_UPDATE", "Actualizar plantilla de documento"),
                    ("DOCUMENT_TEMPLATE_DELETE", "Eliminar plantilla de documento"),
                    ("LAB_ANALYTE_CREATE", "Crear analito de laboratorio"),
                    ("LAB_ANALYTE_UPDATE", "Actualizar analito de laboratorio"),
                    ("LAB_ANALYTE_DELETE", "Eliminar analito de laboratorio"),
                    ("SUCURSAL_CREATE", "Crear sucursal"),
                    ("SUCURSAL_UPDATE", "Actualizar sucursal"),
                    ("SUCURSAL_ACTIVATE", "Reactivar sucursal"),
                    ("SUCURSAL_DEACTIVATE", "Desactivar sucursal"),
                    ("SUCURSAL_SET_DEFAULT", "Marcar sucursal como predeterminada"),
                    ("DOCTOR_SUCURSALES", "Asignar sucursales a médico"),
                    (
