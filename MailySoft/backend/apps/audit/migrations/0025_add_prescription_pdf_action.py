# Generated for B1.3 — agrega ActionType.PRESCRIPTION_PDF a la bitácora.
# Migración reversible: AlterField es reversible (restaura choices anteriores).
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("audit", "0024_prescription_action_types"),
    ]
