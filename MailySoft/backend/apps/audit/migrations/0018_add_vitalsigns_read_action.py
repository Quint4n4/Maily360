# Generated manually for A3-security — agrega VITALSIGNS_READ al ActionType (MEDIO-2).

from django.db import migrations, models


class Migration(migrations.Migration):
    """Agrega VITALSIGNS_READ al campo action de AuditLog.

    Requerido por la corrección MEDIO-2 (NOM-024): las lecturas de signos vitales
    deben quedar registradas en la bitácora de auditoría igual que las lecturas
    de la historia clínica.
    """

    dependencies = [
        ("audit", "0017_add_vitalsigns_create_action"),
    ]
