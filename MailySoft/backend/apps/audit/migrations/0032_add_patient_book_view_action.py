"""
Migración: agrega PATIENT_BOOK_VIEW a ActionType del AuditLog.

PATIENT_BOOK_VIEW se registra cuando un usuario clínico accede al libro
clínico completo del paciente (endpoint GET /expediente/<id>/libro/).
Se prefiere sobre PATIENT_READ porque el libro agrega HC + evoluciones +
recetas en un solo acceso: la diferenciación permite auditorías específicas
de acceso masivo al expediente (NOM-024 §5.3).
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("audit", "0031_alter_auditlog_action"),
    ]
