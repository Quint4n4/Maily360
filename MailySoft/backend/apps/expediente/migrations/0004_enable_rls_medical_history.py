"""
Migración manual: habilita Row Level Security en la tabla de historia clínica.
...
TABLE = "expediente_medical_histories"
POLICY = "expediente_medical_histories_tenant_isolation"
...
class Migration(migrations.Migration):
    """Activa RLS en expediente_medical_histories."""

    dependencies = [
        ("expediente", "0003_add_medical_history"),
