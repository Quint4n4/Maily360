"""
Migración de seguridad: habilita RLS en expediente_longevity_plans.

Patrón idéntico al de 0018_rls_clinical_summaries.py y 0020_rls_treatment_plans.py,
con USING y WITH CHECK desde el inicio (lección aprendida en
0005_rls_with_check.py — ALTO-2: una policy creada solo con USING no
restringe INSERT).
...
_TABLE = "expediente_longevity_plans"
_POLICY = "exp_longevity_plans_tenant_iso"
...
class Migration(migrations.Migration):
    """Habilita RLS con USING y WITH CHECK en expediente_longevity_plans."""

    dependencies = [
        ("expediente", "0023_longevityplan"),
    ]
