"""
Fixtures locales para los tests de la app recetas (B1.1).
...
Mismo patrón que apps/expediente/tests/conftest.py y apps/notificaciones/tests/conftest.py.
"""
...
def api_tenant_ctx(tenant: Any) -> Generator[None, None, None]:
    ...
    Parchea get_current_tenant en el módulo de vistas y en el TenantManager/managers.
    """
    with (
